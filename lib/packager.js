        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!(opts.src.indexOf('.zxp') > -1)) return [3, 2];
                    opts.paths.zxpFile = opts.src;
                    return [3, 4];
                case 2: return [4, createZXP(opts)];
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4:
                    fs_1.mkdirSync(opts.paths.zxpContents);
                    child_process_1.execSync("unzip \"" + opts.paths.zxpFile + "\" -d \"" + opts.paths.zxpContents + "\"");
