...
function createMacOsTemplates(opts) {
    ...
    fs_1.writeFileSync(opts.paths.macOsDistributionXmlFile, distribution_xml_1["default"](opts));
}
...
function createMacOsScripts(opts) {
    ...
    fs_1.writeFileSync(opts.paths.macOsPostinstallFile, postinstall_1["default"](opts));
...
function pkgbuild(opts) {
    ...
    var pkgbuildCmd = (opts.macOs.keychain || opts.macOs.keychainPassword ? [
        ...
        '--install-location', shell_quote_1.quote(["./." + opts.bundleId + "-installer"]),
    ...
    var pkgbuildCmdResult = child_process_1.execSync(pkgbuildCmd).toString();
...
function createWindowsTemplates(opts) {
    ...
    fs_1.writeFileSync(opts.paths.windowsNsisConfFile, nsis_conf_1["default"](opts));
}
