...
function createMacOsScripts(opts) {
    ...
    fs_1.writeFileSync(opts.paths.macOsPostinstallFile, opts.postinstallTemplate ? opts.postinstallTemplate(opts) : postinstall_1["default"](opts));
...
function pkgbuild(opts) {
    ...
    child_process_1.execSync(pkgbuildCmd, { stdio: 'ignore' });
}
...
function createWindowsTemplates(opts) {
    ...
    fs_1.writeFileSync(opts.paths.windowsNsisConfFile, opts.nsisTemplate ? opts.nsisTemplate(opts) : nsis_conf_1["default"](opts));
}
